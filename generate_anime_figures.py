...
def main():
    ...
    draw_uncurated_result_figure(os.path.join(config.result_dir, 'figure02-uncurated-anime-faces-256.png'),
                                 load_Gs(anime_faces_256_url), cx=0, cy=0, cw=256, ch=256, rows=3,
                                 lods=[0, 1, 2, 2, 3, 3], seed=5)
